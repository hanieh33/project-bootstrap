...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="siasi.php">آلودگی هوا</a></li>
                ...
                <li class="single">
                    <div class="post-content">
                        ...
                        <div class="post-image text-center">
                            <img src="img/news24.jpg" class="img-fluid">
                        ...
                        <div class="post-text text-right ">
                            <h3> توکیو امن‌ترین شهر دنیا </h3>
                            <br>
                            <p>
                                برای سومین سال پیاپی، شهر توکیو به عنوان «امن ترین شهر دنیا» انتخاب شد.<br>
                                این رتبه بندی، هر سال توسط «اکونومیست» انجام می شود و شاخصهای امنیت در این ارزیابی، جالب توجه هستند. خلاصه این شاخصها عبارتند از:<br>
                                یک- آمار پائین جرم و خشونت<br>
                                دو- استحکام فراسازه ها در برابر سوانح طبیعی شدید<br>
                                سه- ایمنی شبکه های کامپیوتری در برابر بدافزارها<br>
                                چهار- امنیت بهداشتی<br>
                            ...
                            <div class="comment">
                                <ul class="text-left">
                                    <li class="fa fa-tag">
                                        <a href="Notes.php"><span class="comment-3">توکیو امن‌ترین شهر دنیا</span></a>
