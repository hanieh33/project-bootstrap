...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active" aria-current="page">وزارت ورزش جوانان</li>
                ...
                <li class="single">
                    <div class="post-content">
                        ...
                        <div class="post-image text-center">
                            <img src="img/news10.jpg" class="img-fluid">
                        ...
                        <div class="post-text text-right ">
                            <h3>چهره استقلالی کاپیتان تیم خارجی شد</h3>
                            <br>
                            <p>پژمان منتظری به احتمال بسیار زیاد در این فصل کاپیتان تیم الخریطیات قطر خواهد بود.<br>
                                پژمان منتظری مدافع سابق تیم ملی ایران و باشگاه استقلال که در دو سال گذشته پیراهن آبی پوشان را بر تن کرده بود، بعد از جدایی از این تیم، راهی لیگ قطر شد. پژمان به تیم الخریطیات پیوسته و در این فصل باید لباس این تیم را به تن کند. منتظری که بعد از کشمکش های زیادی از جمع آبی ها جدا شد حالا به نظر می رسد در باشگاه قطری بازوبند کاپیتانی را هم به بازو ببندد. منتظری یکی از باتجربه ترین های تیم قطری است و با توجه به سابقه بازی در لیگ ستارگان این کشور گزینه مناسبی برای قبول چنین مسئولیتی خواهد بود.
