...
<div class="container">
    <nav aria-label="breadcrumb">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item"><a href="siasi.php">سیاسی</a></li>
            <li class="breadcrumb-item active" aria-current="page">فرمانده نیروی دریایی</li>
                ...
                <li class="single">
                    <div class="post-content">
                        ...
                        <div class="post-image text-center">
                            <img src="img/news17.jpg" class="img-fluid">
                        ...
                        <div class="post-text text-right ">
                            <h3>فرمانده نیروی دریایی ارتش:رزمایش امنیت و اقتدار پایدار در دریای خزر برگزار می‌شود</h3>
                            <br>
                            <p>
                                فرمانده نیروی دریایی ارتش جمهوری اسلامی ایران گفت: رزمایش امنیت و اقتدار پایدار در دریای خزر بزودی برگزار می‌شود.<br>
                                ارتش، امیردریادار خانزادی با بیان اینکه بزودی رزمایشی در دریای خزر برگزار می شود گفت: عنوان این رزمایش "امنیت و اقتدار پایدار در دریای خزر" است و پایدار بودنش بسیار به آمادگی رزمی نیرو‌ها و تجهیزات و همکاری کشور‌های همسایه وابسته است.<br>
                                وی گفت: این رزمایش به مدت ۴ روز در دریای خزر برگزار می‌شود و تمام جهت گیری آن نیز دستیابی به امنیت جمعی و حفظ آن است و طبیعی است برای رسیدن به امنیت حتماً باید آمادگی نیرو‌ها، تجهیزات و تسلیحات در سطح معناداری همیشه فراهم باشد.<br>
                                فرمانده نیروی دریایی ارتش افزود: اگر ما آمادگی رزمی خودمان را در دریای خزر حفظ نکنیم، این احتمال وجود دارد که خدای ناکرده فرصتی برای شکل گیری تروریسم جهانی پیش بیاید و جای پایی برای شکل گرفتن ناامنی توسط تروریسم جهانی شکل بگیرد که امروزه بسیاری از مناطق دریایی جهان را درگیر خودش کرده است.
                            ...
                            <div class="comment">
                                <ul class="text-left">
                                    <li class="fa fa-tag">
                                        <a href="siasi.php"><span class="comment-3">فرمانده نیروی هوایی</span></a>
